import MGAP4D.MathlibAnalytic.OrthonormalDiagonalHamiltonianSemigroupOperatorDuhamelAsymptoticallyConstantInputExponentialTrackingEnvelopeUniformHalfMinSettlingTime
import MGAP4D.MathlibAnalytic.FiniteWilsonOSAutomaticExactGapConstructedRealSpectralHamiltonianSemigroupOperatorDuhamelAsymptoticallyConstantInputExponentialTrackingEnvelopeUniformHalfMin
...
/-- Constructed finite Wilson left half-min tracking settling time. -/
theorem finite_wilson_constructed_real_spectral_hamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_uniform_halfMin_left
      ...
      t₀ + max 0
          (Real.log
            ((‖A - finiteWilsonConstructedHamiltonianLeftSteadyState D n F_lim‖ +
                C / (max exactGapValueReal μ - min exactGapValueReal μ / 2)) / ε) /
  ...
  simpa [finiteWilsonConstructedHamiltonianLeftSteadyState,
    ...
    orthonormalDiagonalHamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_uniform_halfMin_left
      ((D.hamiltonianSymmetric n).eigenvectorBasis D.stateFinrank)
...
/-- Constructed finite Wilson right half-min tracking settling time. -/
theorem finite_wilson_constructed_real_spectral_hamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_uniform_halfMin_right
    {W : FiniteWilsonOSAutomaticApproximationFamily}
    (D : FiniteWilsonOSAutomaticExactGapConstructedTransferOrbitContractionData W)
    (n : ℕ) (μ : ℝ) (hμpos : 0 < μ)
    (t₀ : ℝ) (A : D.StateSpace →L[ℝ] D.StateSpace)
  ...
  simpa [finiteWilsonConstructedHamiltonianRightSteadyState,
    ...
    orthonormalDiagonalHamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_uniform_halfMin_right
      ((D.hamiltonianSymmetric n).eigenvectorBasis D.stateFinrank)
      ((D.hamiltonianSymmetric n).eigenvalues D.stateFinrank)
      exactGapValueReal μ (D.hamiltonianEigenvalues_ge_exactGap n)
      exactGapValueReal_pos hμpos t₀ A F U F_lim C hC hF hFC hU0 hUdiag ε hε
