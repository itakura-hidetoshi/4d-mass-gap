import MGAP4D.MathlibAnalytic.R4HilbertSelfAdjointnessInputData
...
def r4HilbertSelfAdjointnessTheoremHamiltonianData
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    R4HilbertHamiltonianInputData I TR :=
  r4HilbertSelfAdjointnessInputHamiltonianData I TR M

def r4HilbertSelfAdjointnessTheoremCarrier
    (M : R4HilbertSelfAdjointnessInputData I TR) : Type :=
  r4HilbertSelfAdjointnessInputCarrier I TR M

def r4HilbertSelfAdjointnessTheoremHamiltonianDomain
    (M : R4HilbertSelfAdjointnessInputData I TR) : Type :=
  r4HilbertSelfAdjointnessInputHamiltonianDomain I TR M

def r4HilbertSelfAdjointnessTheoremCore
    (M : R4HilbertSelfAdjointnessInputData I TR) : Type :=
  r4HilbertSelfAdjointnessInputCore I TR M

def r4HilbertSelfAdjointnessTheoremCoreMap
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    r4HilbertSelfAdjointnessTheoremCore I TR M →
      r4HilbertSelfAdjointnessTheoremHamiltonianDomain I TR M :=
  r4HilbertSelfAdjointnessInputCoreMap I TR M

def r4HilbertSelfAdjointnessTheoremHamiltonianAction
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    r4HilbertSelfAdjointnessTheoremHamiltonianDomain I TR M →
      r4HilbertSelfAdjointnessTheoremCarrier I TR M :=
  r4HilbertSelfAdjointnessInputHamiltonianAction I TR M

theorem r4HilbertSelfAdjointnessTheorem_hamiltonian_handoff
    (M : R4HilbertSelfAdjointnessInputData I TR) :
  ...
  r4HilbertSelfAdjointnessInput_hamiltonian_handoff I TR M

theorem r4HilbertSelfAdjointnessTheorem_core_dense
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.coreDenseForGraphInput :=
  r4HilbertSelfAdjointnessInput_core_dense I TR M

theorem r4HilbertSelfAdjointnessTheorem_adjoint_domain_controlled
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.adjointDomainControlledInput :=
  r4HilbertSelfAdjointnessInput_adjoint_domain_controlled I TR M

theorem r4HilbertSelfAdjointnessTheorem_symmetric_closure
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.symmetricClosureInput :=
  r4HilbertSelfAdjointnessInput_symmetric_closure I TR M

theorem r4HilbertSelfAdjointnessTheorem_deficiency_index_vanishing
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.deficiencyIndexVanishingInput :=
  r4HilbertSelfAdjointnessInput_deficiency_index_vanishing I TR M

theorem r4HilbertSelfAdjointnessTheorem_ready
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.selfAdjointnessInputReady :=
  r4HilbertSelfAdjointnessInput_ready I TR M

theorem r4HilbertSelfAdjointnessTheorem_bundle
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    M.coreDenseForGraphInput ∧ M.adjointDomainControlledInput ∧
      M.symmetricClosureInput ∧ M.deficiencyIndexVanishingInput ∧
        M.selfAdjointnessInputReady :=
  r4HilbertSelfAdjointnessInput_bundle I TR M

/-- The theorem API for the R4 self-adjointness input layer.

This theorem combines the upstream Hamiltonian handoff with the criterion input
obligations. It still does not assert self-adjointness, does not invoke a
spectral theorem, and does not state a spectral-gap result. -/
theorem r4HilbertSelfAdjointnessTheorem_constructed
    (M : R4HilbertSelfAdjointnessInputData I TR) :
    ((M.hamiltonianData.generatorData.semigroupData.osSemigroupReady ∧
      M.hamiltonianData.generatorData.generatorDomainDense ∧
        M.hamiltonianData.generatorData.generatorGraphClosed ∧
  ...
  ⟨r4HilbertSelfAdjointnessTheorem_hamiltonian_handoff I TR M,
    r4HilbertSelfAdjointnessTheorem_bundle I TR M⟩
