import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationActualToolkitPackage
import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationTopWitnessPackage
...
/-! Top-witness and actual-toolkit package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_top_witness_actual_toolkit_package
  ...
  letI : CompleteSpace
    ...
    r4HilbertMathlibSelfAdjointCarrierCompleteSpace I TR M.selfAdjointnessData
  intro hExists
  rcases r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_actual_toolkit_package
      I TR M hExists with
    ⟨hDomain, hDense, hClosed, hAdjEq, hSelfEqAdj, hAdjDomain, hAdjGraph,
      hGraphSelf, hGraphRecover, hFormal, hLeAdj, hAdjLe, _hBoundedPackage⟩
  have hTopWitness :=
    r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_top_witness_package
      I TR M hExists
  exact ⟨hDomain, hDense, hClosed, hAdjEq, hSelfEqAdj, hAdjDomain, hAdjGraph,
    hGraphSelf, hGraphRecover, hFormal, hLeAdj, hAdjLe, hTopWitness⟩
