import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripTheorem
...
/-- Closure for the quotient-section/quotient-map round trip on the selected section range. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripClosure
...
namespace EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripClosure

/-- Build the section-range round-trip closure from the quotient-map faithfulness closure. -/
def ofQuotientMapInjectiveClosure
    ...
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripClosure S K R4 A G H N F C I O Q P R U J V W X :=
  let M := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel.ofQuotientMapInjectiveClosure S K R4 A G H N F C I O Q P R U J V W X
  { sectionRangeRoundTripModel := M
    sectionRangeRoundTripOutputs := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel.sectionRangeRoundTripOutputs_holds M
...
/-- Build the section-range round-trip closure directly from the construction spine. -/
def ofSpine
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine) :
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripClosure S
  ...
  ofQuotientMapInjectiveClosure S
    (EuclideanYangMillsCompleteConstructionClosure.ofSpine S)
    (EuclideanYangMillsR4GaugeFieldConstructionClosure.ofSpine S)
    (EuclideanYangMillsR4GaugeActionClosure.ofSpine S)
    (EuclideanYangMillsR4GaugeInvariantClosure.ofSpine S)
...
/-- Extract the bundled section-range round-trip outputs. -/
theorem sectionRangeRoundTripOutputsHeld
    {S : EuclideanYangMillsContinuumMeasureConstructionSpine}
    {K : EuclideanYangMillsCompleteConstructionClosure S}
    {R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K}
    {A : EuclideanYangMillsR4GaugeActionClosure S K R4}
    ...
    Y.sectionRangeRoundTripModel.sectionRangeRoundTripOutputs :=
  Y.sectionRangeRoundTripOutputs

end EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripClosure
