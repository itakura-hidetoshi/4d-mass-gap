...
/-- Labelled finite-slot readout is measurable, with no injectivity hypothesis
on the time labelling. -/
...
/-- Commonly translated labelled finite-slot readout is measurable. -/
...
labelled finite-slot joint law.
...
same integral against the translated and untranslated finite-slot laws. -/
theorem
