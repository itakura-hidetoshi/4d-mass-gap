...
/-- Diagonal canonical OS convergence of Newton-Hermite interpolants and their
exact remainders on a complete closed half-mass Taylor box, with no rate
relation between admissible time and Taylor degree. -/
theorem VacuumSemigroupGapSlope.admissibleRescaledDefectTaylorPartialSum_realResolventNewtonHermitePair_finiteDimensionalCompression_tendsto_uniform_closedBox_of_tendsto_degree
  ...
  exact
    (G.canonicalRescaledDefectTaylorStrongLimitData T hP hInnerSymmetric hSelf).taylorPartialSum_realResolventNewtonHermitePair_finiteDimensionalCompression_tendsto_uniform_closedBox_of_tendsto_degree
