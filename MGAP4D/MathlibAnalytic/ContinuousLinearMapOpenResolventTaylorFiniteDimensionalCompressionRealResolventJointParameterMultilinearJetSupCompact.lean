  ...
  have hkn : ∀ kn : I, ∀ᶠ a in l, P a kn := by
    ...
    exact
      S.iteratedDeriv_realResolventJointMultilinearResponseCarrier_finiteDimensionalCompression_tendsto_uniformOn_compact_product
        B L hLgap hLresolvent J Q φ kn.1.1 m kn.2.1 H K hKcompact
...
theorem iteratedDeriv_realResolventJointMultilinearTraceCarrierRectangularJet_finiteDimensionalCompression_tendsto_uniformOn_compact_product_sup
  ...
  have hkn : ∀ kn : I, ∀ᶠ a in l, P a kn := by
    intro kn
    exact
      S.iteratedDeriv_realResolventJointMultilinearTraceCarrier_finiteDimensionalCompression_tendsto_uniformOn_compact_product
