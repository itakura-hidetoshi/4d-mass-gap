...
/-! Quotient-carrier coverage to full bounded actual package. -/

/-- Quotient-carrier coverage gives bounded actual data for bare `M`. -/
def r4HilbertMathlibSelfAdjointOperator_quotient_carrier_to_bare_M_bounded_actual_data
...
/-- Quotient-carrier coverage gives the full actual bounded representative package
for bare `M`. -/
theorem r4HilbertMathlibSelfAdjointOperator_quotient_carrier_to_bare_M_bounded_actual_package
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (qcover : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorQuotientCarrierCoverageData I TR M)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
