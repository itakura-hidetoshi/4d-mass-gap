import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataTheorem
...
/-- Closure for the concrete `Equiv` data between the quotient carrier and selected section range. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure
    ...
    (E : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T) where
  sectionRangeEquivDataModel :
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataModel S K R4 A G H N F C I O Q P R U J V W X Y Z T E
  sectionRangeEquivDataOutputs : sectionRangeEquivDataModel.sectionRangeEquivDataOutputs
  sectionRangeEquiv :
  ...
  sectionRangeEquiv_eq : sectionRangeEquiv = EuclideanYangMillsR4HilbertReconstructionQuotient.selectedSectionRangeEquiv I E
  equiv_apply : ∀ q, sectionRangeEquiv q = E.quotientToRange q
  equiv_symm_apply : ∀ x, sectionRangeEquiv.symm x = E.rangeToQuotient x
...
namespace EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure

/-- Build the concrete selected-section-range `Equiv` closure from the equivalence closure. -/
def ofSectionRangeEquivClosure
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine)
    (K : EuclideanYangMillsCompleteConstructionClosure S)
    (R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K)
    (A : EuclideanYangMillsR4GaugeActionClosure S K R4)
    ...
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E :=
  let M := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataModel.ofSectionRangeEquivClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E
  { sectionRangeEquivDataModel := M
    sectionRangeEquivDataOutputs := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataModel.sectionRangeEquivDataOutputs_holds M
    sectionRangeEquiv := M.sectionRangeEquiv
    sectionRangeEquiv_eq := M.sectionRangeEquiv_eq
...
/-- Build the concrete selected-section-range `Equiv` closure directly from the construction spine. -/
def ofSpine
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine) :
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure S
...
/-- Extract the bundled concrete selected-section-range `Equiv` outputs. -/
theorem sectionRangeEquivDataOutputsHeld
    {S : EuclideanYangMillsContinuumMeasureConstructionSpine}
    {K : EuclideanYangMillsCompleteConstructionClosure S}
    {R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K}
    {A : EuclideanYangMillsR4GaugeActionClosure S K R4}
    ...
    D.sectionRangeEquivDataModel.sectionRangeEquivDataOutputs :=
  D.sectionRangeEquivDataOutputs

end EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure
