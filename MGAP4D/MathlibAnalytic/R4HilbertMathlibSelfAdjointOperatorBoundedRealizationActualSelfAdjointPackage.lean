...
import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationOperatorEqualityPackage
...
/-! Actual self-adjointness package over a conditional bounded realization. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_actual_self_adjoint_package
    ...
    M.mathlibOperator.domain = ⊤ ∧
      ...
      ∃ (B : r4HilbertMathlibSelfAdjointCarrier I TR M.selfAdjointnessData →L[ℝ]
            r4HilbertMathlibSelfAdjointCarrier I TR M.selfAdjointnessData),
        B.toPMap ⊤ = M.mathlibOperator ∧ M.mathlibOperator = B.toPMap ⊤ ∧
  ...
  letI : CompleteSpace
    ...
    r4HilbertMathlibSelfAdjointCarrierCompleteSpace I TR M.selfAdjointnessData
  intro hExists
  have hEqualityPackage :=
    r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_operator_equality_package
      I TR M hExists
  rcases hEqualityPackage with
    ⟨hDomain, B, hTop, hActualTop, hAdjTop, hActualAdjTop, hAdjEq,
      hGraphTop, hGraphAdj, hMem, hAction, hActualInner, hInner⟩
  exact ⟨hDomain,
    r4HilbertMathlibSelfAdjointOperator_actual_dense_domain I TR M,
    r4HilbertMathlibSelfAdjointOperator_actual_closed I TR M,
    r4HilbertMathlibSelfAdjointOperator_actual_adjoint_eq_self I TR M,
    r4HilbertMathlibSelfAdjointOperator_actual_self_eq_adjoint I TR M,
    r4HilbertMathlibSelfAdjointOperator_actual_adjoint_domain_eq_domain I TR M,
    r4HilbertMathlibSelfAdjointOperator_actual_adjoint_graph_eq_graph I TR M,
    B, hTop, hActualTop, hAdjTop, hActualAdjTop, hAdjEq,
    hGraphTop, hGraphAdj, hMem, hAction, hActualInner, hInner⟩
