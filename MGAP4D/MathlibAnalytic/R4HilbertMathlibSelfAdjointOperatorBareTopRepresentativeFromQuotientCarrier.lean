...
/-! Quotient-carrier route to bare-`M` continuous representative. -/

/-- With quotient-carrier coverage installed, the actual R4 operator attached to
bare `M` has a continuous top-domain representative. -/
theorem r4HilbertMathlibSelfAdjointOperator_quotient_carrier_to_bare_M_top_representative
