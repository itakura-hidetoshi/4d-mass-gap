import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationGraphExistsPackage
...
/-! Operator equality package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_operator_equality_package
  ...
  letI : CompleteSpace
    ...
    r4HilbertMathlibSelfAdjointCarrierCompleteSpace I TR M.selfAdjointnessData
  intro hExists
  rcases r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_graph_package
      I TR M hExists with
    ⟨hDomain, B, hTop, hAdjEq, hGraphTop, hGraphAdj,
  ...
  exact ⟨hDomain, B, hTop, hActualTop, hAdjTop, hActualAdjTop, hAdjEq,
