import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairCoordinateTransport
...
/-- Quotient-generated coordinate transport and cancellation as a round-trip pair. -/
theorem quotientPairCoordinate_roundTrip
  ...
  constructor
  · exact quotientPairCoordinate_cancel I TR q
  · exact quotientPairCoordinate_forward I TR q

/-- Range-generated coordinate transport and cancellation as a round-trip pair. -/
theorem rangePairCoordinate_roundTrip
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
  ...
  constructor
  · exact rangePairCoordinate_cancel I TR x
  · exact rangePairCoordinate_inverse I TR x
