...
structure EuclideanYangMillsPolishContinuumAnalyticDataFixed
...
attribute [instance]
  EuclideanYangMillsPolishContinuumAnalyticDataFixed.gaugeGroupGroup
  EuclideanYangMillsPolishContinuumAnalyticDataFixed.gaugeGroupTopology
  EuclideanYangMillsPolishContinuumAnalyticDataFixed.gaugeGroupCompact
  EuclideanYangMillsPolishContinuumAnalyticDataFixed.gaugeGroupNontrivial
  EuclideanYangMillsPolishContinuumAnalyticDataFixed.gaugeAction

noncomputable def
    EuclideanYangMillsPolishContinuumAnalyticDataFixed.toContinuumConstruction
    {F : EuclideanYangMillsProjectiveCylinderFamily}
    [∀ x, TopologicalSpace (F.fieldValue x)]
    [∀ x, BorelSpace (F.fieldValue x)]
...
theorem
    EuclideanYangMillsPolishContinuumAnalyticDataFixed.projectiveLimit
    {F : EuclideanYangMillsProjectiveCylinderFamily}
    [∀ x, TopologicalSpace (F.fieldValue x)]
    [∀ x, BorelSpace (F.fieldValue x)]
    [∀ x, PolishSpace (F.fieldValue x)]
...
theorem
    EuclideanYangMillsPolishContinuumAnalyticDataFixed.continuumProbability
    {F : EuclideanYangMillsProjectiveCylinderFamily}
    [∀ x, TopologicalSpace (F.fieldValue x)]
    [∀ x, BorelSpace (F.fieldValue x)]
    [∀ x, PolishSpace (F.fieldValue x)]
