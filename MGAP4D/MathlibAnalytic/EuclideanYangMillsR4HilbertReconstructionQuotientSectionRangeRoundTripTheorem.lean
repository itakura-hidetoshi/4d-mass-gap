import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel
...
/-- Bundled outputs for the section-range round-trip stage. -/
def sectionRangeRoundTripOutputs
    ...
    (M : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel S K R4 A G H N F C I O Q P R U J V W X) :
    Prop :=
...
/-- The section-range round-trip model proves its bundled outputs. -/
theorem sectionRangeRoundTripOutputs_holds
    {S : EuclideanYangMillsContinuumMeasureConstructionSpine}
    {K : EuclideanYangMillsCompleteConstructionClosure S}
    {R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K}
    {A : EuclideanYangMillsR4GaugeActionClosure S K R4}
    ...
    {X : EuclideanYangMillsR4HilbertReconstructionQuotientMapInjectiveClosure S K R4 A G H N F C I O Q P R U J V W}
    (M : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel S K R4 A G H N F C I O Q P R U J V W X) :
    M.sectionRangeRoundTripOutputs :=
...
/-- The quotient-map faithfulness closure induces a section-range round-trip model. -/
theorem nonempty_ofQuotientMapInjectiveClosure
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine)
    (K : EuclideanYangMillsCompleteConstructionClosure S)
    (R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K)
    (A : EuclideanYangMillsR4GaugeActionClosure S K R4)
    ...
    (W : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeUniqueClosure S K R4 A G H N F C I O Q P R U J V)
    (X : EuclideanYangMillsR4HilbertReconstructionQuotientMapInjectiveClosure S K R4 A G H N F C I O Q P R U J V W) :
    Nonempty (EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeRoundTripModel S K R4 A G H N F C I O Q P R U J V W X) :=
  ⟨ofQuotientMapInjectiveClosure S K R4 A G H N F C I O Q P R U J V W X⟩
