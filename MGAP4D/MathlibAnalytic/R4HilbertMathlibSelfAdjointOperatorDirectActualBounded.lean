...
/-! Direct boundedness facade for canonical actual R4 operator data. -/

/-- Bare actual R4 operator data now gives bounded actual data with no route witness. -/
...
/-- Bare actual R4 operator data now gives full actual domain with no route witness. -/
...
/-- Bare actual R4 operator data now gives a continuous full-domain representative
with no route witness. -/
...
/-- The bare actual R4 continuous representative realizes the actual operator on `⊤`. -/
