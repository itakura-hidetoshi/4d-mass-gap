import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationActionExistsPackage
...
/-! Actual inner-action package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_inner_action_package
  ...
  letI : CompleteSpace
    ...
    r4HilbertMathlibSelfAdjointCarrierCompleteSpace I TR M.selfAdjointnessData
  intro hExists
  rcases r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_action_package
      I TR M hExists with
    ⟨hDomain, B, hTop, hAdjEq, hMem, hAction, hInner⟩
  refine ⟨hDomain, B, hTop, hAdjEq, hMem, hAction, ?_, hInner⟩
  intro x y hx
  calc
