import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationExistsPackage
...
/-! Full-domain existential package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_full_domain_package
  ...
  have hExistsPackage :
    ...
    r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_self_adjoint_package
      I TR M ⟨B, p, hp, hB⟩
  exact ⟨hDomain, hExistsPackage⟩
