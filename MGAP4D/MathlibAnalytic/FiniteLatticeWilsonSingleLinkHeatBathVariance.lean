...
/-- Conditional variance under exact single-link Wilson heat-bath resampling. -/
...
/-- Every exact single-link conditional variance is nonnegative. -/
...
/-- Concrete finite-volume spectral target: the public exact gap controls the
finite Gibbs variance by the exact single-link heat-bath Dirichlet form. -/
...
/-- Volume-uniform concrete heat-bath Poincare target for a family of finite
Wilson systems. -/
