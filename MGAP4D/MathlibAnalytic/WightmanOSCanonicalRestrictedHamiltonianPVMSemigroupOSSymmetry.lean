...
/-- The canonical real-linear quotient map from positive-time observables to the
separated OS pre-Hilbert space. -/
...
/-- Positive-time observables map linearly to their dense represented states in
