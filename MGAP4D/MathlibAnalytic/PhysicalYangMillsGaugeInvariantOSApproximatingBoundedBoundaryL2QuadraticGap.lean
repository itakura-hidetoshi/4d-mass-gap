...
The open-half Gram-feature integrability is generated by `Integrable.of_bound`.
The operator-norm estimate is generated from

`‖K_{n,t} v‖² ≤ q(t) ‖v‖²`

by the existing boundary-`L²` quadratic-gap constructor.
Thus the remaining quantitative finite-volume input is the quadratic boundary
transfer estimate itself, together with its intertwining with half-time
translation. -/
structure PhysicalYangMillsEvenPeriodicWilsonOSApproximatingBoundedBoundaryL2QuadraticGapCertificate
...
namespace PhysicalYangMillsEvenPeriodicWilsonOSApproximatingBoundedBoundaryL2QuadraticGapCertificate
...
/-- Generate the direct quadratic boundary-`L²` gap certificate while proving
open-half Gram integrability from finite-measure bounded measurable data. -/
noncomputable def toApproximatingBoundaryL2QuadraticGapCertificate
    (Q : PhysicalYangMillsEvenPeriodicWilsonOSApproximatingBoundedBoundaryL2QuadraticGapCertificate
...
/-- The primitive bounded quadratic package generates the operator-norm
boundary-`L²` transfer gap certificate. -/
...
/-- The primitive bounded quadratic package generates the integrated boundary
moment gap certificate. -/
...
/-- The primitive bounded quadratic package generates the completed finite
...
end PhysicalYangMillsEvenPeriodicWilsonOSApproximatingBoundedBoundaryL2QuadraticGapCertificate
