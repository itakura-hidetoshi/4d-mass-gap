import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedConstructionRoutePackage
...
structure R4HilbertMathlibSelfAdjointOperatorBoundedRouteFamily where
  closedGraphBridge :
...
def r4HilbertMathlibSelfAdjointOperator_bounded_route_family_to_route_data
    (FAM : R4HilbertMathlibSelfAdjointOperatorBoundedRouteFamily I TR)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
    R4HilbertMathlibSelfAdjointOperatorBoundedConstructionRouteData I TR M :=
  { fullDomainData := FAM.fullDomainData M
    closedGraphBridge := FAM.closedGraphBridge }

theorem r4HilbertMathlibSelfAdjointOperator_bounded_route_family_domain_eq_top
    (FAM : R4HilbertMathlibSelfAdjointOperatorBoundedRouteFamily I TR)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
  ...
  r4HilbertMathlibSelfAdjointOperator_domain_eq_top_from_full_domain_data I TR M
    (FAM.fullDomainData M)

theorem r4HilbertMathlibSelfAdjointOperator_bounded_route_family_top_representative
    (FAM : R4HilbertMathlibSelfAdjointOperatorBoundedRouteFamily I TR)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
    (letI : NormedAddCommGroup
        (r4HilbertMathlibSelfAdjointCarrier I TR M.selfAdjointnessData) :=
  ...
  r4HilbertMathlibSelfAdjointOperator_bounded_construction_route_top_representative I TR M
    (r4HilbertMathlibSelfAdjointOperator_bounded_route_family_to_route_data I TR FAM M)

theorem r4HilbertMathlibSelfAdjointOperator_bounded_route_family_package
    (FAM : R4HilbertMathlibSelfAdjointOperatorBoundedRouteFamily I TR)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
    (letI : NormedAddCommGroup
        (r4HilbertMathlibSelfAdjointCarrier I TR M.selfAdjointnessData) :=
  ...
  r4HilbertMathlibSelfAdjointOperator_bounded_construction_route_to_bounded_actual_package I TR M
    (r4HilbertMathlibSelfAdjointOperator_bounded_route_family_to_route_data I TR FAM M)
