import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationSelfAdjointPackage
...
/-! Existential package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_self_adjoint_package
  ...
  have hPackage :=
    r4HilbertMathlibSelfAdjointOperator_actual_bounded_realization_self_adjoint_package
      I TR M B p hp hB
  exact ⟨B, hPackage.2.1, hPackage.2.2.1, hPackage.2.2.2⟩
