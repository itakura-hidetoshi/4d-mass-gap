import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBareBoundedActualRouteFromHamiltonianCoverage
...
/-! Hamiltonian element coverage to bare bounded actual route. -/

/-- Hamiltonian element coverage supplies the bare bounded actual route witness. -/
def r4HilbertMathlibSelfAdjointOperator_bare_bounded_actual_route_from_hamiltonian_elements
...
/-- Hamiltonian element coverage gives bounded actual data for bare `M`. -/
def r4HilbertMathlibSelfAdjointOperator_hamiltonian_elements_to_bare_M_bounded_actual_data
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (EC : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorHamiltonianElementCoverageData I TR M)
...
/-- Hamiltonian element coverage gives nonempty bounded actual data for bare `M`. -/
theorem r4HilbertMathlibSelfAdjointOperator_hamiltonian_elements_to_bare_M_bounded_actual_nonempty
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (EC : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorHamiltonianElementCoverageData I TR M)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
    Nonempty (R4HilbertMathlibSelfAdjointOperatorBoundedActualData I TR M) := by
  exact ⟨r4HilbertMathlibSelfAdjointOperator_hamiltonian_elements_to_bare_M_bounded_actual_data I TR
    hBridge EC M⟩

/-- Hamiltonian element coverage gives a continuous top-domain representative. -/
theorem r4HilbertMathlibSelfAdjointOperator_hamiltonian_elements_to_bare_M_top_representative
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (EC : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorHamiltonianElementCoverageData I TR M)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
