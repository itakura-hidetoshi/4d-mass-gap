...
import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationInnerSymmetric
...
/-! Top-witness package for conditional bounded realizations. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_top_witness_package
  ...
  have hpTop : p = ⊤ :=
    r4HilbertMathlibSelfAdjointOperator_actual_bounded_realization_submodule_eq_top
      I TR M B p hp hB
  have hTop : B.toPMap ⊤ = M.mathlibOperator :=
  ...
  exact ⟨B, p, hp, hpTop, hB, hTop, hDomain, hAdjEq, hGraphTop, hGraphAdj,
