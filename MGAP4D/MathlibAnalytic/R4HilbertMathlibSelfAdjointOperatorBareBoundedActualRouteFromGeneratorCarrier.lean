import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBareBoundedActualRouteFromGeneratorLift
...
/-! Generator-carrier coverage to bare bounded actual route. -/

/-- Generator-carrier coverage supplies the bare bounded actual route witness. -/
def r4HilbertMathlibSelfAdjointOperator_bare_bounded_actual_route_from_generator_carrier
...
/-- Generator-carrier coverage gives bounded actual data for bare `M`. -/
def r4HilbertMathlibSelfAdjointOperator_generator_carrier_to_bare_M_bounded_actual_data
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (gcover : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorGeneratorCarrierCoverageData I TR M)
...
/-- Generator-carrier coverage gives nonempty bounded actual data for bare `M`. -/
theorem r4HilbertMathlibSelfAdjointOperator_generator_carrier_to_bare_M_bounded_actual_nonempty
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (gcover : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorGeneratorCarrierCoverageData I TR M)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
    Nonempty (R4HilbertMathlibSelfAdjointOperatorBoundedActualData I TR M) := by
  exact ⟨r4HilbertMathlibSelfAdjointOperator_generator_carrier_to_bare_M_bounded_actual_data I TR
    hBridge gcover M⟩

/-- Generator-carrier coverage gives a continuous top-domain representative. -/
theorem r4HilbertMathlibSelfAdjointOperator_generator_carrier_to_bare_M_top_representative
    (hBridge : r4HilbertMathlibSelfAdjointOperatorClosedGraphFullDomainToContinuousRepresentativeBridge I TR)
    (gcover : ∀ (M : R4HilbertMathlibSelfAdjointOperatorData I TR),
      R4HilbertMathlibSelfAdjointOperatorGeneratorCarrierCoverageData I TR M)
    (M : R4HilbertMathlibSelfAdjointOperatorData I TR) :
