import MGAP4D.MathlibAnalytic.OrthonormalDiagonalHamiltonianSemigroupOperatorDuhamelAsymptoticallyConstantInputExponentialTrackingEnvelopeTunableResonantSettlingTime
...
/-- Constructed finite Wilson tunable resonant left tracking settling time. -/
theorem finite_wilson_constructed_real_spectral_hamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_tunable_resonant_left
  ...
  simpa [finiteWilsonConstructedHamiltonianLeftSteadyState,
    ...
    orthonormalDiagonalHamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_tunable_resonant_left
      ((D.hamiltonianSymmetric n).eigenvectorBasis D.stateFinrank)
      ((D.hamiltonianSymmetric n).eigenvalues D.stateFinrank)
      exactGapValueReal ν (D.hamiltonianEigenvalues_ge_exactGap n)
      exactGapValueReal_pos hνpos hνgap t₀ A F U F_lim C hC hF hFC hU0 hUdiag ε hε

/-- Constructed finite Wilson tunable resonant right tracking settling time. -/
theorem finite_wilson_constructed_real_spectral_hamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_tunable_resonant_right
    {W : FiniteWilsonOSAutomaticApproximationFamily}
    (D : FiniteWilsonOSAutomaticExactGapConstructedTransferOrbitContractionData W)
    (n : ℕ) (ν : ℝ) (hνpos : 0 < ν) (hνgap : ν < exactGapValueReal)
    (t₀ : ℝ) (A : D.StateSpace →L[ℝ] D.StateSpace)
  ...
  simpa [finiteWilsonConstructedHamiltonianRightSteadyState,
    ...
    orthonormalDiagonalHamiltonianSemigroup_operator_duhamel_asymptoticallyConstantInput_norm_sub_le_epsilon_after_exponentialTrackingEnvelope_tunable_resonant_right
      ((D.hamiltonianSymmetric n).eigenvectorBasis D.stateFinrank)
      ((D.hamiltonianSymmetric n).eigenvalues D.stateFinrank)
      exactGapValueReal ν (D.hamiltonianEigenvalues_ge_exactGap n)
      exactGapValueReal_pos hνpos hνgap t₀ A F U F_lim C hC hF hFC hU0 hUdiag ε hε
