...
/-- The concrete continuum interaction proposition generated by single-link
heat-bath data. -/
abbrev FiniteEvenFourTorusZ2CanonicalGaugeSingleLinkHeatBathInteractionProp
    (n : ℕ)
    (D : FiniteWilsonGibbsSingleSourceSingleLinkHeatBathOSLimitData
      (finiteEvenFourTorusZ2CanonicalGaugeRealization
        H β energyIdentity energyNontrivial latticeSpacing volumeScale
        hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
        finiteVolumeEuclideanCovariant
        finiteVolumeEuclideanCovariant_proof n)) : Prop :=
  finiteWilsonAutomaticContinuumCylinderConnectedCorrelation
      ...
      (finiteEvenFourTorusZ2CanonicalGaugeInteractionWitness
        ...
        hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
        finiteVolumeEuclideanCovariant
        finiteVolumeEuclideanCovariant_proof n).rightObservable ≠ 0
...
theorem finiteEvenFourTorusZ2CanonicalGauge_singleLinkHeatBath_interaction_passes_to_continuum
    ...
    (D : FiniteWilsonGibbsSingleSourceSingleLinkHeatBathOSLimitData
      (finiteEvenFourTorusZ2CanonicalGaugeRealization
        ...
        finiteVolumeEuclideanCovariant
        finiteVolumeEuclideanCovariant_proof n)) :
    FiniteEvenFourTorusZ2CanonicalGaugeSingleLinkHeatBathInteractionProp
      H β energyIdentity energyNontrivial latticeSpacing volumeScale
      hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
      finiteVolumeEuclideanCovariant finiteVolumeEuclideanCovariant_proof n D := by
  letI : Nonempty
      ((finiteEvenFourTorusZ2AutomaticApproximationFamily
        H β energyIdentity energyNontrivial latticeSpacing volumeScale
        hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
...
/-- The concrete Hamiltonian mass-gap endpoint generated by the single-link
heat-bath construction. -/
abbrev FiniteEvenFourTorusZ2CanonicalGaugeSingleLinkHeatBathMassGapProp
    (n : ℕ)
    (D : FiniteWilsonGibbsSingleSourceSingleLinkHeatBathOSLimitData
      (finiteEvenFourTorusZ2CanonicalGaugeRealization
        H β energyIdentity energyNontrivial latticeSpacing volumeScale
    ...
    (definitionBridge : OSWightmanExactGapDefinitionBridge)
    (definitionBridge_uses_measure_axioms :
      definitionBridge.spine.axioms = measureBridge.axioms) : Prop :=
  let C :=
...
theorem finiteEvenFourTorusZ2CanonicalGauge_singleLinkHeatBath_mass_gap
    ...
    (definitionBridge_uses_measure_axioms :
      definitionBridge.spine.axioms = measureBridge.axioms) :
    FiniteEvenFourTorusZ2CanonicalGaugeSingleLinkHeatBathMassGapProp
      H β energyIdentity energyNontrivial latticeSpacing volumeScale
      hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
      finiteVolumeEuclideanCovariant finiteVolumeEuclideanCovariant_proof
      n D measureBridge measureBridge_identified definitionBridge
      definitionBridge_uses_measure_axioms := by
  letI : Nonempty
      ((finiteEvenFourTorusZ2AutomaticApproximationFamily
        H β energyIdentity energyNontrivial latticeSpacing volumeScale
        hβ hEnergyIdentity hEnergyNontrivial geometricEnergy
