import MGAP4D.MathlibAnalytic.R4HilbertMathlibSelfAdjointOperatorBoundedRealizationActualSelfAdjointPackage
...
/-! Actual toolkit package over a conditional bounded realization. -/

theorem r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_actual_toolkit_package
  ...
  letI : CompleteSpace
    ...
    r4HilbertMathlibSelfAdjointCarrierCompleteSpace I TR M.selfAdjointnessData
  intro hExists
  rcases r4HilbertMathlibSelfAdjointOperator_actual_exists_bounded_realization_actual_self_adjoint_package
      I TR M hExists with
    ⟨hDomain, hDense, hClosed, hAdjEq, hSelfEqAdj, hAdjDomain, hAdjGraph,
      B, hTop, hActualTop, hAdjTop, hActualAdjTop, hBoundedAdjEq,
      hGraphTop, hGraphAdj, hMem, hAction, hActualInner, hInner⟩
  have hToolkit := r4HilbertMathlibSelfAdjointOperator_actual_toolkit_package I TR M
  exact ⟨hDomain, hDense, hClosed, hAdjEq, hSelfEqAdj, hAdjDomain, hAdjGraph,
    hToolkit.2.2.1, hToolkit.2.2.2.1, hToolkit.2.2.2.2.1,
    hToolkit.2.2.2.2.2.1, hToolkit.2.2.2.2.2.2,
    B, hTop, hActualTop, hAdjTop, hActualAdjTop, hBoundedAdjEq,
    hGraphTop, hGraphAdj, hMem, hAction, hActualInner, hInner⟩
