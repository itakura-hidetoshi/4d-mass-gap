import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairProjectionModel
...
/-- Bundled outputs for quotient/selected-range transport-pair projections. -/
def sectionRangeTransportPairProjectionOutputs
    ...
    (M : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairProjectionModel S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR) :
    Prop :=
  (∀ q, (EuclideanYangMillsR4HilbertReconstructionQuotient.quotientToTransportPair I TR q).1 = q) ∧
    (∀ q, (EuclideanYangMillsR4HilbertReconstructionQuotient.quotientToTransportPair I TR q).2 = TR.forwardTransport q) ∧
      (∀ x, (EuclideanYangMillsR4HilbertReconstructionQuotient.rangeToTransportPair I TR x).1 = TR.inverseTransport x) ∧
        (∀ x, (EuclideanYangMillsR4HilbertReconstructionQuotient.rangeToTransportPair I TR x).2 = x) ∧
          (∀ q,
...
/-- The transport-pair projection model proves its bundled outputs. -/
theorem sectionRangeTransportPairProjectionOutputs_holds
    {S : EuclideanYangMillsContinuumMeasureConstructionSpine}
    {K : EuclideanYangMillsCompleteConstructionClosure S}
    {R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K}
    {A : EuclideanYangMillsR4GaugeActionClosure S K R4}
    ...
    {TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D}
    (M : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairProjectionModel S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR) :
    M.sectionRangeTransportPairProjectionOutputs :=
  ⟨M.quotientPair_fst,
    M.quotientPair_snd,
    M.rangePair_fst,
    M.rangePair_snd,
...
/-- The transport-pair closure induces projection identities. -/
theorem nonempty_ofTransportPairClosure
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine)
    (K : EuclideanYangMillsCompleteConstructionClosure S)
    (R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K)
    (A : EuclideanYangMillsR4GaugeActionClosure S K R4)
    ...
    Nonempty (EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairProjectionModel S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR) :=
  ⟨ofTransportPairClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR PCL⟩
