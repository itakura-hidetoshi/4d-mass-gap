import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure
...
/-- Paired carrier for a quotient class and its selected section-range representative. -/
abbrev selectedSectionRangeTransportPair
  ...
  quotientCarrier I × selectedSectionRangeCarrier I X

/-- Pair a quotient class with its transported selected representative. -/
def quotientToTransportPair
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (q : quotientCarrier I) :
    selectedSectionRangeTransportPair I X :=
  (q, TR.forwardTransport q)

/-- Pair a selected representative with its inverse-transported quotient class. -/
def rangeToTransportPair
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
...
/-- The quotient-generated pair is cancelled by inverse transport. -/
theorem quotientToTransportPair_cancel
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (q : quotientCarrier I) :
    TR.inverseTransport (quotientToTransportPair I TR q).2 = (quotientToTransportPair I TR q).1 :=
  TR.forward_inverse_cancel q

/-- The range-generated pair is cancelled by forward transport. -/
theorem rangeToTransportPair_cancel
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (x : selectedSectionRangeCarrier I X) :
    TR.forwardTransport (rangeToTransportPair I TR x).1 = (rangeToTransportPair I TR x).2 :=
  TR.inverse_forward_cancel x

end EuclideanYangMillsR4HilbertReconstructionQuotient

/-- Model recording quotient/selected-range transport pairs. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairModel
...
/-- Build the transport-pair model from the transport closure. -/
def ofSectionRangeEquivTransportClosure
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine)
    (K : EuclideanYangMillsCompleteConstructionClosure S)
    (R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K)
    (A : EuclideanYangMillsR4GaugeActionClosure S K R4)
  ...
  { pairCarrier := EuclideanYangMillsR4HilbertReconstructionQuotient.selectedSectionRangeTransportPair I X
    ...
    reflectionPositive := TR.reflectionPositive
    euclideanInvariant := TR.euclideanInvariant
    gaugeInvariant := TR.gaugeInvariant }
