import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTheorem
...
/-- Closure for the range of the quotient section in the R4 Hilbert reconstruction route. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeClosure
  ...
  sectionRangeOutputs : sectionRangeModel.sectionRangeOutputs
...
namespace EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeClosure

/-- Build the quotient-section range closure from the quotient-section injectivity closure. -/
def ofSectionInjectiveClosure
  ...
  let M := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeModel.ofSectionInjectiveClosure S K R4 A G H N F C I O Q P R U J
  { sectionRangeModel := M
    sectionRangeOutputs := EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeModel.sectionRangeOutputs_holds M
    sectionRange := M.sectionRange
    sectionMemRange := M.sectionMemRange
    rangeHasClass := M.rangeHasClass
    rangeProjectsToWitness := M.rangeProjectsToWitness
...
/-- Build the quotient-section range closure directly from the construction spine. -/
def ofSpine
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine) :
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeClosure S
...
/-- Extract the bundled quotient-section range outputs. -/
theorem sectionRangeOutputsHeld
    {S : EuclideanYangMillsContinuumMeasureConstructionSpine}
    {K : EuclideanYangMillsCompleteConstructionClosure S}
    {R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K}
    {A : EuclideanYangMillsR4GaugeActionClosure S K R4}
    ...
    V.sectionRangeModel.sectionRangeOutputs :=
  V.sectionRangeOutputs

end EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeClosure
