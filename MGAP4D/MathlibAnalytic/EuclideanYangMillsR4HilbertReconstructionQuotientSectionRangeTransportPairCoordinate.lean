import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairTupleClosure
...
/-- The quotient coordinate of a quotient-generated transport pair. -/
def quotientPairQuotientCoord
    ...
    (q : quotientCarrier I) : quotientCarrier I :=
  (quotientToTransportPair I TR q).1

/-- The selected-range coordinate of a quotient-generated transport pair. -/
def quotientPairRangeCoord
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    {D : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E}
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (q : quotientCarrier I) : selectedSectionRangeCarrier I X :=
  (quotientToTransportPair I TR q).2

/-- The quotient coordinate of a range-generated transport pair. -/
def rangePairQuotientCoord
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    {D : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E}
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (x : selectedSectionRangeCarrier I X) : quotientCarrier I :=
  (rangeToTransportPair I TR x).1

/-- The selected-range coordinate of a range-generated transport pair. -/
def rangePairRangeCoord
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    {D : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivDataClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E}
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (x : selectedSectionRangeCarrier I X) : selectedSectionRangeCarrier I X :=
  (rangeToTransportPair I TR x).2

/-- Quotient-generated quotient coordinate. -/
theorem quotientPairQuotientCoord_eq
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (q : quotientCarrier I) :
    quotientPairQuotientCoord I TR q = q :=
  rfl

/-- Quotient-generated selected-range coordinate. -/
theorem quotientPairRangeCoord_eq
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (q : quotientCarrier I) :
    quotientPairRangeCoord I TR q = TR.forwardTransport q :=
  rfl

/-- Range-generated quotient coordinate. -/
theorem rangePairQuotientCoord_eq
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    rangePairQuotientCoord I TR x = TR.inverseTransport x :=
  rfl

/-- Range-generated selected-range coordinate. -/
theorem rangePairRangeCoord_eq
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (TR : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivTransportClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D)
    (x : selectedSectionRangeCarrier I X) :
    rangePairRangeCoord I TR x = x :=
  rfl

end EuclideanYangMillsR4HilbertReconstructionQuotient

/-- Closure exposing named coordinate functions for transport pairs. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairCoordinateClosure
    ...
    (TPC : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairTupleClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR PCL PPC) where
...
namespace EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairCoordinateClosure

/-- Build the coordinate closure from the tuple closure. -/
def ofTransportPairTupleClosure
    (S : EuclideanYangMillsContinuumMeasureConstructionSpine)
    (K : EuclideanYangMillsCompleteConstructionClosure S)
    (R4 : EuclideanYangMillsR4GaugeFieldConstructionClosure S K)
    (A : EuclideanYangMillsR4GaugeActionClosure S K R4)
    ...
    EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairCoordinateClosure S K R4 A G H N F C I O Q P R U J V W X Y Z T E D TR PCL PPC TPC :=
  { quotientPairQuotientCoord_eq := EuclideanYangMillsR4HilbertReconstructionQuotient.quotientPairQuotientCoord_eq I TR
    quotientPairRangeCoord_eq := EuclideanYangMillsR4HilbertReconstructionQuotient.quotientPairRangeCoord_eq I TR
    rangePairQuotientCoord_eq := EuclideanYangMillsR4HilbertReconstructionQuotient.rangePairQuotientCoord_eq I TR
    rangePairRangeCoord_eq := EuclideanYangMillsR4HilbertReconstructionQuotient.rangePairRangeCoord_eq I TR
    quotientPair_eq := TPC.quotientPair_eq
    rangePair_eq := TPC.rangePair_eq
    reflectionPositive := TPC.reflectionPositive
    euclideanInvariant := TPC.euclideanInvariant
    gaugeInvariant := TPC.gaugeInvariant }

end EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeTransportPairCoordinateClosure
