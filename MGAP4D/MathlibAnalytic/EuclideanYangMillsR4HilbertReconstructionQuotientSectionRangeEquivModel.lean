import MGAP4D.MathlibAnalytic.EuclideanYangMillsR4HilbertReconstructionQuotientSectionRepresentativeProjectionClosure
...
/-- The selected section range as a carrier. -/
abbrev selectedSectionRangeCarrier
  ...
  {x : inputCarrier I // x ∈ X.sectionRange}

/-- Map a quotient class to its selected section-range representative. -/
def quotientToSelectedSectionRange
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (q : quotientCarrier I) :
    selectedSectionRangeCarrier I X :=
  ⟨quotientSection I q, T.sectionRepresentativeMemRange q⟩

/-- Map a selected section-range representative back to its quotient class. -/
def selectedSectionRangeToQuotient
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
...
/-- Going from a quotient class to the selected range and back returns the quotient class. -/
theorem selectedSectionRange_rightInverse
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (T : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRepresentativeProjectionClosure S K R4 A G H N F C I O Q P R U J V W X Y Z)
    (q : quotientCarrier I) :
    selectedSectionRangeToQuotient I X (quotientToSelectedSectionRange I T q) = q := by
  exact T.sectionRepresentativeProjection q

/-- Going from the selected range to the quotient class and back returns the selected representative. -/
theorem selectedSectionRange_leftInverse
    (I : EuclideanYangMillsR4ReflectionPositiveReconstructionInputClosure S K R4 A G H N F C)
    {O : EuclideanYangMillsR4HilbertReconstructionCarrierClosure S K R4 A G H N F C I}
    {Q : EuclideanYangMillsR4HilbertReconstructionQuotientClosure S K R4 A G H N F C I O}
    {P : EuclideanYangMillsR4HilbertReconstructionQuotientProjectionClosure S K R4 A G H N F C I O Q}
    ...
    (T : EuclideanYangMillsR4HilbertReconstructionQuotientSectionRepresentativeProjectionClosure S K R4 A G H N F C I O Q P R U J V W X Y Z)
    (x : selectedSectionRangeCarrier I X) :
    quotientToSelectedSectionRange I T (selectedSectionRangeToQuotient I X x) = x := by
  cases x with
  | mk x hx =>
      apply Subtype.ext
      exact Y.sectionRangeRoundTrip hx

end EuclideanYangMillsR4HilbertReconstructionQuotient

/-- Model recording the carrier-level equivalence between quotient classes and the selected section range. -/
structure EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivModel
...
namespace EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivModel

/-- Build the section-range equivalence model from the representative projection closure. -/
def ofSectionRepresentativeProjectionClosure
  ...
  { quotientToRange := EuclideanYangMillsR4HilbertReconstructionQuotient.quotientToSelectedSectionRange I T
    rangeToQuotient := EuclideanYangMillsR4HilbertReconstructionQuotient.selectedSectionRangeToQuotient I X
    rightInverse := EuclideanYangMillsR4HilbertReconstructionQuotient.selectedSectionRange_rightInverse I T
    leftInverse := EuclideanYangMillsR4HilbertReconstructionQuotient.selectedSectionRange_leftInverse I T
    sectionRepresentativeProjection := T.sectionRepresentativeProjection
    reflectionPositive := T.reflectionPositive
    euclideanInvariant := T.euclideanInvariant
    gaugeInvariant := T.gaugeInvariant }

end EuclideanYangMillsR4HilbertReconstructionQuotientSectionRangeEquivModel
