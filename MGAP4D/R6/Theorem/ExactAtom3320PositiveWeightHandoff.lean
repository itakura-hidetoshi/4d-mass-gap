...
/-- Handoff surface from the R6 observable-atom/PVM compatibility lane to the
...
/-- The handoff surface from R6 compatibility to positive spectral weight is ready. -/
