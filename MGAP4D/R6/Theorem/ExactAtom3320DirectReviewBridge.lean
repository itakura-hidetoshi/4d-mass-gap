...
/-- R6 bridge from the direct R5 observable review surface to the compatibility lane. -/
...
/-- The R6 direct-review bridge reaches the compatibility lane. -/
...
theorem exact_atom_3320_direct_review_bridge_value_mem_atom :
  ...
  rcases exact_atom_3320_direct_review_bridge_ready with
    ⟨_hdirect, _hhandoff, _htarget, _hblocked, _hlaws, hinAtom, _hnoWeight, _hr4⟩
  exact hinAtom

/-- Projection: the direct-review bridge keeps the value-origin boundary active. -/
theorem exact_atom_3320_direct_review_bridge_value_origin_blocked :
    ExactAtom3320ValueOriginBlocked := by
  rcases exact_atom_3320_direct_review_bridge_ready with
    ⟨_hdirect, _hhandoff, _htarget, hblocked, _hlaws, _hinAtom, _hnoWeight, _hr4⟩
  exact hblocked

/-- Boundary: the direct exact-atom bridge still does not consume positive spectral weight. -/
theorem exact_atom_3320_direct_review_bridge_does_not_consume_positive_weight :
  ...
  rcases exact_atom_3320_direct_review_bridge_ready with
    ⟨_hdirect, _hhandoff, _htarget, _hblocked, _hlaws, _hinAtom, hnoWeight, _hr4⟩
  exact hnoWeight
