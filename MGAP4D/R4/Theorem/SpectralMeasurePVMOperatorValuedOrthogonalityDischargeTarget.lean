...
def spectralMeasurePVMOperatorValuedOrthogonalityDischargeTarget :
  ...
  { projectionValuednessHandoffReady :=
    ...
    projectionProductZeroTargeted := True
    reversedProjectionProductZeroTargeted := True
    rangeOrthogonalityTargeted := True
    innerProductOrthogonalityTargeted := True
    pairwiseFamilyOrthogonalityTargeted := True
