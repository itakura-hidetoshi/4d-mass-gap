...
spectral-measure/PVM layer.  This packet therefore starts from the already-closed
R3 dense diagonal `LinearPMap` self-adjointness handoff and records the R4 input
state for spectral measure and PVM construction.  It does not claim the concrete
spectral measure or concrete PVM construction yet. -/
