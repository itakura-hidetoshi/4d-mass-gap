...
FORBIDDEN_STALE_REPLAY_ANCHORS = (
...
def main() -> None:
    ...
    failures.extend(forbid_all(doc, FORBIDDEN_STALE_REPLAY_ANCHORS, "replay-certificate", DOC_PATH))
    ...
    failures.extend(forbid_all(gate, FORBIDDEN_STALE_REPLAY_ANCHORS, "gate", GATE_PATH))
